...
events, lineups, matches = gfd.get_statsbomb_data(competition, year, save_to_file=True, folderpath=f"../../data_directory/statsbomb_data/{int(year)-1}_{str(int(year.replace('20','')))}/{competition}")
