...
prog_passes = events_df[(events_df['progressive_pass']==True) & (events_df['x']>=50)]
...
if norm_mode == None:
    ...
    sorted_df = playerinfo_reduced_df.sort_values(['suc_prog_passes_100teampass', 'suc_prog_passes'], ascending=[False, False])
    sorted_df = sorted_df.drop(sorted_df[sorted_df['mins_played'] <= min_mins].index)
